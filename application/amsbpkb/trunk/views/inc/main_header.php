				...
				<li class="dropdown user user-menu">
					...
					<ul class="dropdown-menu">
						...
						<li class="user-header">
							...
							<p><?= $active_user->fstUserName ?> - Web Developer	<small>Member since Nov. 2012</small></p>
						</li>						
						<!-- Menu Body -->
						<li class="user-body">							
						</li>
						...
						<li class="user-footer">
							<div class="pull-left"><a href="<?=site_url()?>master/user/changepassword" class="btn btn-default btn-flat">Change Password</a></div>
